// Copied from Prism's ParseableLoader component
export function ParseableLoader({ text = "Loading" }: { text?: string }) {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      >
        <defs>
          ...
          <filter id="iconfilterGreen" primitiveUnits="objectBoundingBox">
      ...
      <p className="mt-2 text-sm text-parseableBlue-500 flex items-center">
        {text}
